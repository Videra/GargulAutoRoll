...
["Temple of Ahn'Qiraj"] = {
    ["The Prophet Skeram"] = {
        ...
        234974, -- Staff of the Qiraji Prophets (Void Touched)
    ...
    ["Battleguard Sartura"] = {
        ...
        234977, -- Silithid Claw (Void Touched)
    ...
    ["Twin Emperors"] = {
        ...
        234981, -- Kalimdor's Revenge (Void Touched)
    ...
    ["Ouro"] = {
        ...
        234983, -- Larvae of the Great Worm (Void Touched)
        235045, -- Imperial Qiraji Regalia
        235046, -- Imperial Qiraji Armaments
        233365, -- Ouro's Intact Hide
        233367, -- Skin of the Great Sandworm
    },
    ["C'Thun"] = {
        21221, -- Eye of C'Thun
        ...
        235014, -- Scepter of the False Prophet (Void Touched)
        ...
        234985, -- Dark Edge of Insanity (Void Touched)
        233641, -- Cloak of Clarity
        233642, -- Mark of C'Thun
        233634, -- Death's Sting
        234984, -- Death's Sting (Void Touched)
    },
    ["Hardmode"] = {
        234984, -- Death's Sting (Void Touched)
        235014, -- Scepter of the False Prophet (Void Touched)
        ...
        234650, -- Ancient Qiraji Ripper (Void Touched)
        234977, -- Silithid Claw (Void Touched)
        234976, -- Wand of Qiraji Nobility (Void Touched)
        234974, -- Staff of the Qiraji Prophets (Void Touched)
        234975, -- Hammer of Ji'zhi (Void Touched)
        234987, -- Neretzek, The Blood Drinker (Void Touched)
        235282, -- Antenna of Invigoration (Void Touched)
        234986, -- Anubisath Warhammer (Void Touched)
        234998, -- The Lost Kris of Zedd (Void Touched)
        234997, -- Silithid Husked Launcher (Void Touched)
        234996, -- Gavel of Qiraji Authority (Void Touched)
    },
    ["Trash"] = {
        ...
        233358, -- Twilight Qiraji Resonating Crystal
    ...
    ["Yauj Dies Last"] = {
        ...
        233564, -- Mantle of the Desert's Fury
        233565, -- Ukko's Ring of Darkness
        233566, -- Mantle of the Desert Crusade
        233567, -- Bile-Covered Gauntlets
    },
    ["Kri Dies Last"] = {
...
["Ahn'Qiraj Formulas"] = {
    [""] = { -- Unknown
        ...
        234275, -- Formula: Enchanted Prayer Tome
        234276, -- Formula: Enchanted Totem
        234277, -- Formula: Enchanted Mushroom
        233997, -- Formula: Enchant Chest - Living Stats
        233998, -- Formula: Enchant Gloves - Holy Power
        233999, -- Formula: Enchant Gloves - Arcane Power
        235133, -- Formula: Libram of Righteousness
        235134, -- Formula: Libram of the Exorcist
        235135, -- Formula: Libram of Sanctity
        235136, -- Formula: Totem of Pyroclastic Thunder
        235137, -- Formula: Totem of Thunderous Strikes
        235138, -- Formula: Totem of Flowing Magma
        235139, -- Formula: Idol of Sidereal Wrath
...
---------------------------------------------------------------------------------------------------------------
    ["Ruins of Ahn'Qiraj"] = {
        ["Kurinnaxx"] = {
            ...
            234989, -- Qiraji Sacrificial Dagger (Void-Touched)
        ...
        ["General Rajaxx"] = {
            ...
            234990, -- Manslayer of the Qiraji (Void-Touched)
        ...
        ["Ayamiss the Hunter"] = {
            ...
            234991, -- Bow of Taut Sinew (Void Touched)
            234097, -- Stinger of Ayamiss
            234992, -- Stinger of Ayamiss (Void Touched)
        ...
        ["Ossirian the Unscarred"] = {
            ...
            234993, -- Crossbow of Imminent Doom (Void Touched)
        ...
        ["AQ opening"] = {
            21025, -- The First Step of the Qiraji
            21137, -- The Eye of the Qiraji
            21138, -- The Summoning of the Qiraji
            21139, -- Qiraji Opening Ceremonies
            21175, -- The Final Step of the Qiraji
            21176, -- The Release of the Qiraji
            21517, -- The Calling of the Qiraji
            21520, -- The Chronicles of the Qiraji
            21521, -- The Oath of the Qiraji
            21522, -- The Legend of the Qiraji
            21523, -- The Binding of the Qiraji
            21526, -- The Battle for the Qiraji
            21529, -- Hand of the Qiraji
            21530, -- Heart of the Qiraji
            21531, -- The Qiraji War Ritual
            21532, -- The Qiraji War Declaration
        },
        ["Ahn'Qiraj enchants"] = {
            20727, -- Enchant Cloak - Shadow Protection
            20728, -- Enchant Cloak - Subtlety
            20729, -- Enchant Cloak - Greater Resistance
            20730, -- Enchant Cloak - Fire Resistance
            20731, -- Enchant Cloak - Frost Resistance
            20734, -- Enchant Cloak - Protection
            20736, -- Enchant Cloak - Greater Protection
        },
        ["Ahn'Qiraj scarabs"] = {
            20858, -- Stone Scarab
            20859, -- Gold Scarab
...
---------------------------------------------------------------------------------------------------------------
    ["Blackwing Lair"] = {
        ...
        ["Firemaw"] = {
            ...
            230842, -- Cloak of Draconic Might (Firemaw, Flamegor)
            230844, -- Draconic Maul (Firemaw, Flamegor)
            230847, -- Essence Gatherer (Firemaw, Flamegor)
            231710, -- Draconian Leggings
            231718, -- Primeval Leggings
            231727, -- Ancient Leggings
        },
        ...
        ["Trials"] = {
            232550, -- Ashkandi, Greatsword of the Brotherhood (Shadowflame)
            232551, -- Draconic Maul (Shadowflame)
            232552, -- Lok'amir il Romathis (Shadowflame)
            232555, -- Crul'shorukh, Edge of Chaos (Shadowflame)
            232556, -- Staff of the Shadow Flame (Shadowflame)
            232557, -- Claw of Chromaggus (Shadowflame)
            232558, -- Chromatically Tempered Sword (Shadowflame)
            232559, -- Herald of Woe (Shadowflame)
            232561, -- Claw of the Black Drake (Shadowflame)
            232562, -- Shadow Wing Focus Staff (Shadowflame)
            232563, -- Drake Talon Cleaver (Shadowflame)
            232564, -- Maladath, Runed Blade of the Black Flight (Shadowflame)
            232565, -- Dragonfang Blade (Shadowflame)
            232566, -- The Untamed Blade (Shadowflame)
            232567, -- Spineshatter (Shadowflame)
        },
        ["Trash"] = {
...
---------------------------------------------------------------------------------------------------------------
    ["Zul'Gurub"] = {
        ...
        ["Bloodlord Mandokir"] = {
            ...
            230995, -- Bloodtinged Kilt
            230996, -- Bloodsoaked Pauldrons
            230997, -- Blooddrenched Grips
        ...
        ["High Priestess Arlokk"] = {
            ...
            230944, -- High Priestess Arlokk's Item
        },
        ["Jin'do the Hexxer"] = {
            19716, -- Primal Hakkari Bindings
            19717, -- Primal Hakkari Armsplint
        ...
        ["Bloodied"] = {
            231846, -- Gri'lek's Carver (Bloodied)
            231847, -- Gri'lek's Grinder (Bloodied)
            231848, -- Nat Pagle's Fish Terminator (Bloodied)
            231849, -- Tigule's Harpoon (Bloodied)
            231850, -- Will of Arlokk (Bloodied)
            231851, -- Arlokk's Grasp (Bloodied)
            231852, -- Gurubashi Dwarf Destroyer (Bloodied)
            231853, -- Warblade of the Hakkari (Bloodied)
            231854, -- Zin'rokh, Destroyer of Worlds (Bloodied)
            231855, -- Fang of the Faceless (Bloodied)
            231856, -- Ancient Hakkari Manslayer (Bloodied)
            231857, -- Touch of Chaos (Bloodied)
            231858, -- Bloodcaller (Bloodied)
            231859, -- Jin'do's Hexxer (Bloodied)
            231860, -- Jin'do's Judgement (Bloodied)
            231861, -- Jeklik's Crusher (Bloodied)
            231862, -- Blazefury Retributer (Bloodied)
            231863, -- Thoughtblighter (Bloodied)
            231864, -- Pitchfork of Madness (Bloodied)
            231865, -- Zulian Scepter of Rites (Bloodied)
            231866, -- Mar'li's Touch (Bloodied)
            231867, -- Bloodlord's Defender (Bloodied)
            231868, -- Mandokir's Sting (Bloodied)
            231869, -- Warblade of the Hakkari (Bloodied)
            231870, -- Halberd of Smiting (Bloodied)
            231871, -- Wushoolay's Poker (Bloodied)
            231872, -- Hoodoo Hunting Bow (Bloodied)
            231873, -- Zulian Stone Axe (Bloodied)
            231874, -- Fang of Venoxis (Bloodied)
            231875, -- Thekal's Grasp (Bloodied)
            231876, -- Zulian Slicer (Bloodied)
            232310, -- Renataki's Soul Conduit (Bloodied)
        },
        ["All bosses"] = {
...
---------------------------------------------------------------------------------------------------------------
    ["Molten Core"] = {
        ...
        ["Sulfuron Harbinger"] = {
            ...
            227536, -- Incandescent Shoulders
            227537, -- Incandescent Cape
            227750, -- Molten Scaled Bindings
            227751, -- Molten Scaled Belt
            227752, -- Molten Scaled Cape
            227754, -- Molten Scaled Shoulders
            227755, -- Molten Scaled Helm
            227756, -- Molten Scaled Gloves
            227757, -- Molten Scaled Boots
        ...
        ["Golemagg the Incinerator"] = {
            ...
            228289, -- Choken of the Fire Lord
        ...
        ["Majordomo Executus"] = {
            ...
            228296, -- Perdition's Blade (Gutgore Ripper)
        ...
        ["Ragnaros"] = {
            ...
            228266, -- Essence of the Pure Flame (Drillborer Disk)
            228286, -- Band of Accuria
            228287, -- Band of Sulfuras
            228288, -- Bonereaver's Edge
            228289, -- Choker of the Firelord
            228290, -- Cloak of the Shrouded Mists
        ...
        ["The Molten Core"] = {
            ...
            228287, -- Band of Sulfuras
            228288, -- Bonereaver's Edge
            228299, -- Spinal Reaper (Molten)
            228511, -- Perdition's Blade (Molten)
        },
        ["Heat3"] = {
            228145, -- Magmadar's Right Claw (Molten)
            228146, -- Magmadar's Left Claw (Molten)
            228299, -- Spinal Reaper (Molten)
            228350, -- Eskhandar's Right Claw (Molten)
            228459, -- Obsidian Edged Blade (Molten)
            228462, -- Aurastone Hammer (Molten)
            228463, -- Earthshaker (Molten)
            228506, -- Brutality Blade (Molten)
            228511, -- Perdition's Blade (Molten)
            228517, -- Azuresong Mageblade (Molten)
            228519, -- Striker's Mark (Molten)
            228702, -- Drillborer Disk (Molten)
            229372, -- Gutgore Ripper (Molten)
            229373, -- Faithbringer (Molten)
            229374, -- Fist of the Firesworn (Molten)
            229376, -- Sorcerous Dagger (Molten)
            229377, -- Magmadar's Left Claw (Molten)
            229379, -- Eskhandar's Right Claw (Molten)
            229380, -- Shadowstrike (Molten)
            229382, -- Hyperthermically Insulated Lava Dredger (Molten)
        },
        ["All bosses"] = {
...
---------------------------------------------------------------------------------------------------------------
    ["Onyxia"] = {
        ["Onyxia"] = {
            ...
            228250, -- Plans: Stronger-hold Gauntlets
...
function GargulAutoRoll.Items.GetItems()
    if GargulAutoRoll.IsSoD then
        return GargulAutoRoll.Items.SoD
    else
        return GargulAutoRoll.Items.Classic
    end
end